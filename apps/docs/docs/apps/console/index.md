...
The console application is the main user dashboard for managing accounts, media, playlists, and billing at `console.secretlobby.co`.

## Overview

- **Package**: `@secretlobby/console`
- **Port**: 3001
- **Production URL**: https://console.secretlobby.co
