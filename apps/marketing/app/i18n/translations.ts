...
export const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    hero: {
      ...
      demo: "Watch Demo",
      stat1Value: "100%",
      stat1Label: "Private & Secure",
      stat2Value: "24/7",
      stat2Label: "Always Available",
      stat3Value: "∞",
      stat3Label: "Unlimited Lobbies",
    },
    features: {
    ...
    cta: {
      ...
      titleHighlight: "your music securely?",
      subtitle: "Join hundreds of artists who already trust Secret Lobby to connect with record labels professionally and securely.",
      button: "Create My First Lobby",
      sales: "Talk to Sales",
    ...
    modal: {
      ...
      subtitle: "We're in closed beta. Leave your email and we'll send you an invitation soon.",
      placeholder: "you@email.com",
      button: "Request Invitation",
      submitting: "Sending...",
      privacy: "We don't share your email with third parties.",
      success: "Thanks for your interest! We'll send you an invite soon.",
      alreadyRegistered: "You're already on our list! We'll be in touch soon.",
    },
    errors: {
  ...
  es: {
    ...
    cta: {
      ...
      titleHighlight: "tu música de forma segura?",
      subtitle: "Únete a cientos de artistas que ya confían en Secret Lobby para conectar con record labels de manera profesional y segura.",
      button: "Crear mi Primer Lobby",
      sales: "Hablar con Ventas",
      freeNote: "Comienza gratis, sin tarjeta de crédito requerida",
      benefit1: "Configuración en 2 minutos",
      benefit2: "Soporte 24/7",
      benefit3: "Cancela cuando quieras",
    },
    footer: {
    ...
    modal: {
      ...
      subtitle: "Estamos en beta cerrada. Deja tu email y te enviaremos una invitación pronto.",
      placeholder: "tu@email.com",
      button: "Solicitar Invitación",
      submitting: "Enviando...",
      privacy: "No compartimos tu email con terceros.",
      success: "¡Gracias por tu interés! Te enviaremos una invitación pronto.",
      alreadyRegistered: "¡Ya estás en nuestra lista! Te contactaremos pronto.",
    },
    errors: {
