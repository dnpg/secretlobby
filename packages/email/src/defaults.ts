  ...
  <tr>
    <td align="center" style="padding:24px 24px 16px 24px; text-align:center;">
      <img
        ...
        width="100"
        height="100"
        style="display:block; border:0; outline:none; text-decoration:none; margin:0 auto; width:100px; height:100px;"
      />
    </td>
  </tr>
</table>`;
...
/**
 * Wrapper: 2026-ready responsive email container.
 * - Outer: full-width table, centered cell with responsive padding (24px 16px).
 * - Inner: single content table, width 100% / max-width 600px / min-width 280px for desktop + small screens.
 * - Meta: viewport, x-apple-disable-message-reformatting, format-detection for best rendering.
 */
